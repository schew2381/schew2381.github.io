...
Compression comes first, which is the half people forget:
...
Oversized values are the case where the two engines agree, and they agree because the value is too big for anybody's page. The size makes the decision for them. Take the size away and the disagreement starts.
