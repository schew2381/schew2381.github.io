...
The answer is a mechanism called a Heap-Only Tuple, and when an update qualifies for it, Postgres writes the new version and touches no indexes at all.
